<template>
    <div class="empty-list" style="margin-bottom:18px">
        <div class="none-title">
            <img
                src="https://cdn.kkday.com/pc-web/assets/img/empty_state/travel_buddy.svg"
            />
            <h4 class="text-muted text-center">尚未建立常用旅客資料</h4>
            <a class="btn btn-primary add-buddy">新增常用旅客</a>
        </div>
    </div>
</template>
