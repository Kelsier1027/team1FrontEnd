...
<template>
    <div class="board">
        <div class="page-head">
            <h1>KKday 折扣券</h1>
            <div class="row coupon-list__retain">
                <div class="col-md-6">
            ...
            <div class="kk-tabs row">
                <div class="kk-tabs__header">
                    <div class="kk-tabs__header-padding-left"></div>
                    <nav class="kk-tabs__tab-list">
                        <a class="kk-tabs__tab kk-tabs__tab--active"
                            ><!---->
                            <div class="kk-tabs__tab-text">
                                <span> 可使用 </span
                                ><!---->
                            </div></a
                        ><a class="kk-tabs__tab"
                            ><!---->
                            <div class="kk-tabs__tab-text">
                                <span> 已使用 </span
                                ><!---->
                    ...
                    <div class="kk-tabs__header-padding-right"></div>
                    <div
                        class="kk-tabs__indicator"
                        style="
                            --indicator-width: 50px;
                            --indicator-offset: 24px;
                        "
                    ></div>
                </div>
            </div>
            ...
            <div class="tab-pane in active">
                ...
                <div class="empty-list">
                    <div class="none-title">
                        <img
                            src="https://cdn.kkday.com/pc-web/assets/img/empty_state/coupon_list.svg"
                        />
        ...
        <div role="dialog" class="modal fade modal--basic" id="coupon-detail">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">折扣券詳情</h4>
                        <!---->
                    </div>
                    <div class="modal-body">
                        <div class="coupon-detail__body">
                            <h4
                                class="coupon-detail__body--title break-word"
                            ></h4>
                            <!---->
                            <div class="coupon-detail__body--sub-block">
                                <h5 class="coupon-detail__body--sub-title">
                                    優惠內容
                                </h5>
                                <div class="coupon-detail__body--content"></div>
                            </div>
                            <div class="coupon-detail__body--sub-block">
                                <h5 class="coupon-detail__body--sub-title">
                                    折扣碼
                            ...
                            <div class="coupon-detail__body--sub-block">
                                ...
                                <div class="coupon-detail__body--content">
                                    ~
                                </div>
                            </div>
                            <div class="coupon-detail__body--sub-block">
                            ...
                            <div class="coupon-detail__body--sub-block">
                                ...
                                <div
                                    class="coupon-detail__body--content break-word"
                                >
                                    <ul
                                        class="coupon-detail__body--list-block"
                                    ></ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="coupon-detail__footer">
                            <button
                                data-dismiss="modal"
...
.upper-bar-enter-active,
.upper-bar-leave-active {
...
.alert-snackbar--bottom {
    bottom: 72px;
}

.alert-snackbar--upper {
    top: 84px;
}
