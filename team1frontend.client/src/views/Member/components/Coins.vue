...
<template>
    <div class="board">
        <a
            href="https://www.kkday.com/zh-tw/point/redeem"
            class="btn btn-primary pull-right"
        >
            兌換獨家好禮
        </a>
        <h1 class="mt-0">KKday Points</h1>
        <span>目前可使用點數：</span>
        <span class="critical-info text-lg text-nowrap"
            ><svg class="custom-kk-icon">
                <use xlink:href="#ic_kkpoint"></use>
            </svg>
            <span class="product-pricing text-warning"> 0 </span></span
        >
    </div>
    <div class="board point-board">
        <div class="point-info">
            <h2>點數怎麼用？</h2>
            <p>
                KKday Points 可於下次預定折抵訂單金額，每 50 點可折抵 USD
                0.25，還能兌換獨家好禮。
                <a
                    href="https://help.kkday.com/zh-TW/support/solutions/folders/16000092240"
                    target="_blank"
                    rel="noopener"
                    class="btn-link"
                >
            ...
            <div class="info-list">
                <a href="https://www.kkday.com/zh-tw/"
                    ><div class="item">
                        <h5 class="title">
                            <img
                                src="https://cdn.kkday.com/pc-web/assets/img/ic-calendar.svg"
                                class="ic_calendar"
                            />
                            預訂行程
                        </h5>
                        <p class="detail">
                            消費金額 USD 1 可得 1 點，快註冊會員賺取點數！
                        </p>
                    </div></a
                >
                <a data-toggle="modal" data-target="#app-promotion-modal"
                    ><div class="item">
                        <h5 class="title">
                            <img
                                src="https://cdn.kkday.com/pc-web/assets/img/ic-together.svg"
                                class="ic_together"
                            />
                            邀請好友下單（App）
                        </h5>
                        <p class="detail">揪好友一起玩，還能獲得點數！</p>
                    </div></a
                >
                <a href="https://www.kkday.com/zh-tw/member/missionlist"
                    ><div class="item">
                        <h5 class="title">
                            <img
                                src="https://cdn.kkday.com/pc-web/assets/img/ic-mission.svg"
                                class="ic_mission"
                            />
                            完成任務
                        </h5>
                        <p class="detail">接受限時挑戰，賺取額外點數！</p>
                    </div></a
                >
            </div>
        </div>
    ...
    <div class="board">
        <div class="page-head">
            <ul class="nav nav-tabs page-tab mt-15">
                <li class="active"><a href="#point">點數紀錄 </a></li>
                <li class=""><a href="#gift">好禮兌換紀錄 </a></li>
            </ul>
        </div>
        <div class="tab-content">
            <div class="empty-list">
                <h4 class="text-grey text-center">您尚無點數記錄</h4>
            </div>
            <!---->
        </div>
    </div>
